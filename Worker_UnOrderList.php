...
<?php
    ...
    $result = $conn->query("SELECT * FROM `gas_order` inner join `assign` on gas_order.ORDER_Id = assign.ORDER_Id where assign.WORKER_Id='$id' and !gas_order.DELIVERY_Condition='1'");
